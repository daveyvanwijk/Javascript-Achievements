    ...
    function makeThisSentence(){
        ...
        let woord4 = was[index];
        let woord5 = rest[index];
    ...
    const onderwerp = ["ik", "hij", "zij"];
    const werkwoord = ["ben", "is", "zijn"];
    const restwoord = ["cool", "gek", "dronken"];
    const was = ["maar", "niet", "zal nooit"];
    const rest = ["niet meer", "meer", "veranderen"];
